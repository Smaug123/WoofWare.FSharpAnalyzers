    ...
    in {
      ...
      in {
        ...
        default = pkgs.buildDotnetModule {
          ...
          name = "WoofWare.FSharpAnalyzers";
          src = ./.;
          projectFile = "./WoofWare.FSharpAnalyzers/WoofWare.FSharpAnalyzers.fsproj";
          testProjectFile = "./WoofWare.FSharpAnalyzers.Test/WoofWare.FSharpAnalyzers.Test.fsproj";
